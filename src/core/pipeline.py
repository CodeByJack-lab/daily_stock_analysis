...
# SocialSentimentService removed in Step 4 cleanup.
...
class StockAnalysisPipeline:
    ...
    def __init__(
        ...
        # Social sentiment service removed in Step 4 cleanup.
    ...
    def analyze_stock(self, code: str, report_type: ReportType, query_id: str) -> Optional[AnalysisResult]:
        ...
        try:
            ...
            # Social sentiment step removed in Step 4 cleanup.
    ...
    def _analyze_with_agent(
        ...
        try:
            ...
            # Agent-mode social sentiment injection removed in Step 4 cleanup.
