...
class NotificationService(TelegramSender):
    ...
    # ===== Context channel (DingTalk/Feishu Stream removed in Step 3 cleanup) =====
    def _has_context_channel(self) -> bool:
        """Context channels removed; always False."""
        return False

    def send_to_context(self, content: str) -> bool:
        """No-op kept for pipeline compatibility after Stream platforms removal."""
        return False
